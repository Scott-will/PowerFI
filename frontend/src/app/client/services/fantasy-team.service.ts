...
export class FantasyTeamService {
    ...
    getAllFantasyTeams(): Observable<[FantasyTeam]> {
        return this.http.get<[FantasyTeam]>(this.configService.getApiUrl() + this.getTeamsUrl);      
    }
    ...
    getAllFantasyTeamStats(queryParams : {[key : string]:string}): Observable<[TeamTransactionStats]> {
        ...
        return this.http.get<[TeamTransactionStats]>(this.configService.getApiUrl() + this.getTeamStatsUrl, {params});      
    }
}